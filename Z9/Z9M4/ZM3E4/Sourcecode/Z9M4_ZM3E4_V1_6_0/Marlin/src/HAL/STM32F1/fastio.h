...
#define _SET_OUTPUT_LOW(IO)     _SET_MODE(IO, GPIO_OUTPUT_PP)
#define _SET_OUTPUT(IO)         _SET_MODE(IO, GPIO_OUTPUT_PP)
#define _SET_OUTPUT_OD(IO)      _SET_MODE(IO, GPIO_OUTPUT_OD)

#define OUT_WRITE_LOW(IO,V)     do{ _SET_OUTPUT_LOW(IO); WRITE(IO,V); }while(0)
...
#define SET_OUTPUT_AF_OD(IO)    _SET_MODE(IO, GPIO_AF_OUTPUT_OD)
#define SET_OUTPUT_AF_PP(IO)    _SET_MODE(IO, GPIO_AF_OUTPUT_PP)
